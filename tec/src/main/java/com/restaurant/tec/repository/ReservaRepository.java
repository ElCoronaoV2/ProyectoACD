...
public interface ReservaRepository extends JpaRepository<ReservaEntity, Long> {
    ...
    // Buscar reservas pendientes urgentes (para cancelación automática)
    @Query("SELECT r FROM ReservaEntity r WHERE r.estado = com.restaurant.tec.entity.ReservaEntity.EstadoReserva.PENDIENTE AND r.fechaHora BETWEEN :start AND :end")
